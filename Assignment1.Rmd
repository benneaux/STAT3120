...
a = 15
b = 40
posterior.dist <- dbeta(x, a + 1, b - a + 1)
plot(x, posterior.dist, type = 'l')

```

>>>>>>> 837a7ea25253d3512485d5a7b1c41de2f78b18f3
...
a2 <-  3
b2 <-  15
dist <- dbeta(x, (a1 + a2) + 1, (b1 + b2) - (a1 + a2) + 1)
plot(x,dist,type='l')
data <- rbeta(10000, (a1 + a2) + 1, (b1 + b2) - (a1 + a2) + 1)
mean(data>0.5)
mean(data)
