...
$$f(\theta) \propto \theta^5(1-\theta)^5$$ We are also given that the data could represent only two possible outcomes - either all heads or all tails. Therefore, the likelihood of the data is equal to:
...
```{r Q3}
theta <- seq(0,1,0.01)
dens  <- theta^5*(1-theta)^10 + theta^10*(1-theta)^5
plot(theta,dens,ylim=c(0,1.1*max(dens)),type="l",xlab="theta",ylab="",
xaxs="i",yaxs="i",yaxt="n",bty="n",cex=1)
```
